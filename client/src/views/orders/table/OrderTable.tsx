...
//             fromDate: tempStartDate ? tempStartDate.toISOString() : null,
//             toDate: tempEndDate ? tempEndDate.toISOString() : null,
//           },
//         });
...
//       }
//     }, 1200);
//   }, [paginationModel.page, paginationModel.pageSize, sort, sortColumn, searchText, tempStartDate, tempEndDate]);
...
//   const handleGoClick = () => {
//     // Update state with selected dates and fetch data
